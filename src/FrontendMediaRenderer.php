<?php
     ...
     *
     * Optional: show description + author under the media box.
     *
     ...
     * @package Frontend
     */
    class FrontendMediaRenderer extends Panel
    {
        ...
        protected function renderMiniGallery(ContentCoverMedia $objCoverMedia): string
        {
            ...
            if ($objCoverMedia->getPreviewFileId() === null) {
              return '';
            }

            $src = $this->strTempUrl . $objCoverMedia->getPreviewFilePath();

            $strHtml = '';
            $strHtml .= _nl(_indent('<div class="media-box">',1));
            $strHtml .= _nl(_indent('<div class="multi-images-container">', 2));
            $strHtml .= _nl(_indent('<img src="' . $src . '" alt="">',3));
            $strHtml .= _nl(_indent('<span class="gallery-img" aria-hidden="true">', 3));
            $strHtml .= _nl(_indent('<img src="' . $this->strMultiImagesIconPath . '">', 4));
        ...
        protected function renderVideo(ContentCoverMedia $objCoverMedia): string
        {
            ...
            $strHtml = _nl(_indent('<div class="media-box is-16x9 no-pointer-events">',1));
