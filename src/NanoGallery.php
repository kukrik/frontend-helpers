<?php
    ...
    class NanoGallery extends Panel
    {
        ...
        protected function registerFiles(): void
        {
            ...
            //$this->AddJavascriptFile(FRONTEND_HELPERS_ASSETS_URL . "/js/jquery.nanogallery2.js");
         ...
         *
         * @return mixed The value of the requested property. The type of the return value depends on the requested
         *     property and may include strings, integers, booleans, arrays, or objects.
         ...
         * @param mixed $mixValue The value to assign to the property. The value is validated and cast to the expected
         *     type.
         *
         * @return void
         *
